...
const tmpRoot = temp.mkdirSync('phptools');
...
global._phpToolsIsLocal = true;
global._phpToolsRoot = path.resolve(__dirname, '../..');
                    ...
                    if (fs.existsSync(maybeTsPath)) {
                        ...
                        try {
                            if (!fs.existsSync(tmpJsonSchemaPath)) {
                                const quicktypePath = path.join(__dirname, '../scripts/tools/quicktype.js');
